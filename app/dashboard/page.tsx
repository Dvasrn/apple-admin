...
const client = new ApolloClient({
  uri:
    ...
    "https://back-end-smoky-alpha.vercel.app/api/graphql",
...
const categoryRoutes: Record<string, string> = {
  ...
  getAllMacBookAir: "macbook_air",
  getAllMacBookPro: "macbook_pro",
  getAllMacMini: "mac_mini",
  getAllMacStudio: "mac_studio",
  getAllMacPro: "mac_pro",
  getAllMacBookNeo: "macbook",
  getAlliPads: "ipad",
  getAllWatch: "watch",
  getAllAirPods: "airpods",
  getAllVision: "vision",
};
                    ...
                    {Object.entries(STATUS).map(([key, cfg]) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <p
                            className={`text-[11px] font-medium mt-1 ${cfg.color}`}
                          >
                            {cfg.label}
                          </p>
                        </button>
              ...
              <div className="space-y-4">
                <div className="flex flex-wrap gap-2">
                  <div className="relative flex-1 min-w-[200px]">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-neutral-500 text-[13px]">
                      🔍
                    </span>
                    <input
                      type="text"
              ...
              <div className="space-y-4">
                <div className="flex flex-wrap gap-2">
                  ...
                  <div className="flex gap-1.5 flex-wrap">
                    {[
                      { id: "all", label: "Бүгд" },
                      ...Object.entries(STATUS).map(([id, c]) => ({
                        id,
                        label: c.label,
                      })),
                    ].map((s) => (
